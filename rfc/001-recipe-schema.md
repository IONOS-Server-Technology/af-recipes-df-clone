...
| `min_ram_mb` | integer | yes | Minimum RAM in MB required to run. |
| `min_cpu_cores` | integer | yes | Minimum CPU cores required. |
| `min_disk_gb` | integer | yes | Minimum disk space in GB. |
