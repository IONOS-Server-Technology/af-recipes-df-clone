#!/usr/bin/env bash
# install.sh — Install Teable via docker-compose
set -euo pipefail
...
af_gen_secret BACKEND_JWT_SECRET
...
mkdir -p /opt/teable/data
mkdir -p /opt/teable/postgres
mkdir -p /opt/teable/redis
