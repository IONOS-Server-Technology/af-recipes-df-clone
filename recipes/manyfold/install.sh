#!/usr/bin/env bash
# install.sh — Install Manyfold via docker-compose
set -euo pipefail
...
# Persistent data: model library files and Postgres data.
mkdir -p /opt/manyfold/libraries
mkdir -p /opt/manyfold/postgres
