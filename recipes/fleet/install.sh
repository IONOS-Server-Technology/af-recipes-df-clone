#!/usr/bin/env bash
# install.sh — Install Fleet via docker-compose
set -euo pipefail
...
af_gen_secret FLEET_SERVER_PRIVATE_KEY
...
mkdir -p /opt/fleet/mysql
mkdir -p /opt/fleet/redis
mkdir -p /opt/fleet/data
mkdir -p /opt/fleet/logs
mkdir -p /opt/fleet/vulndb
