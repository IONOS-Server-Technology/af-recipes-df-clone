#!/usr/bin/env bash
# install.sh — Install Firefly III via docker-compose
set -euo pipefail
...
# Laravel requires APP_KEY in the form base64:<32 random bytes base64-encoded>.
af_gen_app_key() {
...
af_gen_secret STATIC_CRON_TOKEN
...
mkdir -p /opt/firefly-iii/upload
mkdir -p /opt/firefly-iii/mariadb
