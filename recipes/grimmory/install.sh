#!/usr/bin/env bash
# install.sh — Install Grimmory via docker-compose
set -euo pipefail
...
af_gen_secret MARIADB_ROOT_PASSWORD
...
mkdir -p /opt/grimmory/books
mkdir -p /opt/grimmory/bookdrop
mkdir -p /opt/grimmory/data
mkdir -p /opt/grimmory/mariadb
