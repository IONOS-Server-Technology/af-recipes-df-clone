#!/usr/bin/env bash
# install.sh — Install Strapi via docker-compose
set -euo pipefail
...
af_gen_secret APP_KEYS
af_gen_secret API_TOKEN_SALT
af_gen_secret ADMIN_JWT_SECRET
af_gen_secret TRANSFER_TOKEN_SALT
...
# Persistent data: SQLite database and uploaded media.
mkdir -p /opt/strapi/data
mkdir -p /opt/strapi/uploads
